...
from advanced_data import read_instances, build_vocabulary, save_vocabulary, index_instances, load_glove_embeddings
...
if __name__ == '__main__':
    ...
    config = [{"pos_dis_limit": 50, "filter_num": 128, "dropout_ratio": 0.5, "gpu": False, "filters": [2,3,4,5], "word_emb_dim": 100, "pos_emb_dim": 10, "vocab_size": vocab_size, "embed_dim": args.embed_dim}]
    ...
    train_output = train(model, optimizer, train_instances, val_instances,
                         args.epochs, args.batch_size, save_serialization_dir, advanced=True)
